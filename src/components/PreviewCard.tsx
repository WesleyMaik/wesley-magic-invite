									...
									{imageLoadFailed ? (
										...
										<div className="relative">
											<img
												...
												className="block rounded-md pointer-events-none bg-neutral-50 dark:bg-neutral-800 align-top"
											...
											<div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white px-2 py-1">
												<h3 className="text-xl">Espaço Bella Fest Brazil</h3>
											</div>
										</div>
									)}
								</a>
